...
var RowChart = (function (_super) {
    __extends(RowChart, _super);
    function RowChart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RowChart.prototype.render = function () {
        return (React.createElement(BaseChart_1.default, __assign({}, this.props, { setChartRef: this.setChart })));
    };
    RowChart.prototype.setChart = function (parent, chartGroup) {
        return dc_1.rowChart(parent, chartGroup);
    };
    return RowChart;
}(React.PureComponent));
